...
INSERT INTO objectives (day_id,type,description,answer,sort) VALUES ('21','learning', 'What is a query?','A query is a task executed against a database, table or combination of tables. e.g. SELECT, INSERT, etc.','3');
INSERT INTO objectives (day_id,type,description,answer,sort) VALUES ('21','learning', 'What is a WHERE clause?', 'A query can filter or restrict the information that results via a WHERE clause.','4');
INSERT INTO objectives (day_id,type,description,answer,sort) VALUES ('21','learning', 'How do I establish a relationship between tables?','You can establish a relationship between tables by creating a column that tells you, for each row, which row in another table it is related to.','5');
INSERT INTO objectives (day_id,type,description,answer,sort) VALUES ('21','learning', 'What is a JOIN clause?','The data that a query has access to, can be expanded via JOIN-ing two tables together.','6');
INSERT INTO objectives (day_id,type,description,answer,sort) VALUES ('21','learning', 'What is an ERD?','In the context of databases, an ERD is a diagram that shows each table as an entity, and also shows the relationships between tables.','7');
INSERT INTO objectives (day_id,type,description,answer,sort) VALUES ('21','performance', 'How do I create a table?','CREATE TABLE objectives
(
    id bigint,
...
-- INSERT INTO objectives (type,description,answer,sort) VALUES (performance, How do I INSERT rows into a table?,"INSERT INTO objectives(id, type, question, answer, sort)

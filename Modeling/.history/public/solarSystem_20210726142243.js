const DELTA = 50; // time-step in milliseconds
...
class Planet {
  ...
  updatePosition(){
    if ($('#state').html() === 'Moving'){
      ...
      getCSSCoords([this.x,this.y,this.mass]);
...
$(document).ready(function(){
  ...
  $('#universe').css('width','500px');
  $('#universe').css('height','500px');
  $('#universe').css('background-color','black');

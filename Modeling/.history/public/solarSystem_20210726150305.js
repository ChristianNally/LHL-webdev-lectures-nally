...
$(document).ready(function () {
  ...
  const earth = new Planet({name:'Earth', x:100, y:100, Vx:-3, Vy:3, mass:1, color:'blue', dynamic: true});
  const x = new Planet({name:'X', x:100, y:100, Vx:-3, Vy:-3, mass:2, color:'yellow', dynamic: true});
  const y = new Planet({ name: "Sun", mass: 50, dynamic: false });
});

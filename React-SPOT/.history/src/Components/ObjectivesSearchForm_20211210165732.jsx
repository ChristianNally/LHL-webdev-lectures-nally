const ObjectivesSearchForm = (props) => {
  ...
  return (
    <div className="ObjectivesSearchForm">
      <tr>
        <input name="search" onChange={(event)=>props.newSearchDetails({...props.searchDetails, search: event.target.value})} type="text" size="30" placeholder="keywords or search strings" /><br/>
